...
export default function OtherToolsIcons() {
  return (
    <div className="icon-links-area">
      ...
      <a href="http://sutta.readingfaithfully.org" title="Look up suttas on web by citation" rel="noreferrer" target="_blank">
      ...
      <a href="https://readingfaithfully.org/lab/" title="Other tools under development" rel="noreferrer" target="_blank" className="labs">
        <img className="icon" width="17px" src={labsIcon} style={{ position: "relative", top: "2px" }} alt="Labs icon" />
      </a>
      <a href="https://github.com/thesunshade/sutta-index#readme" title="The source code for this site" rel="noreferrer" target="_blank">
